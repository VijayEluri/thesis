...
public abstract class FocusableState extends GraphState {
    ...
    public static final Logger LOGGER = LoggerFactory.getLogger(FocusableState.class);
    ...
    protected void focus(int id, Container container) {
        ...
        if (element != null) {
            ...
            getGraphController().publish(new InfoStatusBarTextEvent(getGraphController(), "Focused vertex " + label)); // TODO change it to another event. VertexFocused?
        }
    ...
    public void unfocus() {
        ...
        getGraphController().publish(new InfoStatusBarTextEvent(getGraphController())); // TODO change it to another event. Vertex Unfocused?
    }
