...
public interface Element extends Drawable, Orderable, Positionable, Tooltipable {
    ...
    /**
     * Check does current element equals to any object from the parameter collection.
     *
     * @param objects Collection of objects to check against.
     * @return <code>True</code> if current element equals to any object inside the parameter collection.
