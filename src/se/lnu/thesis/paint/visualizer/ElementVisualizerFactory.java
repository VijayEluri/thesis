...
public class ElementVisualizerFactory {
    ...
    public AbstractElementVisualizer getGOLeafPointVisualizer() {
        return visualizers.get(POINT_GO_LEAF_VERTEX_VISUALIZER);
    }

    public AbstractElementVisualizer getGONodePointVisualizer() {
        return visualizers.get(POINT_GO_NODE_VERTEX_VISUALIZER);
    }
